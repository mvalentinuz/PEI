...
void Editor::colorearSuperficie(int filaOrigen, int columnaOrigen, vector<vector<bool> > region)
{
    Pixel pixelOrigen = imagen->getPixel(filaOrigen, columnaOrigen);
    Pixel pixel;
    int R = pixelOrigen.getR();
    int G = pixelOrigen.getG();
    int B = pixelOrigen.getB();
